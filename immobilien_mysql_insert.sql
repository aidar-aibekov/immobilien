...
insert into haus (address, schaetzung, preis) values ('Tynystanova 14', 3, 27000 );
insert into haus (address, schaetzung, preis) values ('Fuchika 44', 3, 30000 );
insert into haus (address, schaetzung, preis) values ('Manas 4', 5, 95000);
insert into haus (address, schaetzung, preis) values ('Manas 43', 3, 28000;
insert into haus (address, schaetzung, preis) values ('Djal 15', 1, 15000);
...
insert into verkauf(haus_id, name, datum, telefonnummer) values (5, 'Islam', '10.06.2006', '057029834384');
insert into verkauf(haus_id, name, datum, telefonnummer) values (2, 'Dosmir', '08.06.1998', '045635757357');
insert into verkauf(haus_id, name, datum, telefonnummer) values (4, 'Aizada', '24.11.2007', '08867856756');
insert into verkauf(haus_id, name, datum, telefonnummer) values (1, 'Nurbala', '20.1.2016', '0563424657');
insert into verkauf(haus_id, name, datum, telefonnummer) values (3, 'Nagima', '5.3.2015', '07831243626');
...
insert into haus_kaufint (haus_id, kauf_id) values (2, 5);
insert into haus_kaufint (haus_id, kauf_id) values (1, 4);
insert into haus_kaufint (haus_id, kauf_id) values (3, 1);
insert into haus_kaufint (haus_id, kauf_id) values (3, 2);
insert into haus_kaufint (haus_id, kauf_id) values (5, 3);
